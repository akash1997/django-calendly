...
class UserRegisterView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(data="Invalid registeration data received!", status=HTTP_400_BAD_REQUEST)
        if User.objects.filter(username=email).exists():
            return Response(data="This email is already registered, please login!", status=HTTP_400_BAD_REQUEST)
